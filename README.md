...
Earth embeddings promise one geometry in which every city can be compared. [AlphaEarth](https://arxiv.org/abs/2507.22291) gives every 10 m of land a vector of 64 numbers built from Sentinel-1, Sentinel-2 and Landsat, and the numbers carry no definition of what is urban: no classes, no thresholds, only distance. So what do the embeddings look like in cities, generally and compared to other parts of the globe? I got into this by sampling 840,776 locations in 1,000 urban areas across 162 countries, in every annual layer from 2017 to 2024. The list of questions you can ask with or of these embeddings is long, but I dipped my toe into it with these...
...
**How much variation survives inside the standard degrees of urbanisation?** About 91%. The schema is coarse, what it leaves behind is structured, and a typical city spreads its variation over about six directions where the pool of all cities spreads over sixteen.
